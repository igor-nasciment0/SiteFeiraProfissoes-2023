            ...
            <main>
                ...
                <section>
                    ...
                    <div className='resultado-verificacao'> 
                                ...
                                <tbody>
                                    ...
                                    <tr> 
                                        ...
                                        <td className='celula-validado'>
                                            <button className='botao-validado'> <span>Validado</span>
                                            ...
                                            <button className='botao-validar desvalidar' onClick={() => {desvalidar(item.id_inscricao);}}><span>Desvalidar</span>
                        ...
                        <h2>Visitante não encontrado</h2>
